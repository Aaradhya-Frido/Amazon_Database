...
if st.button("Process"):
    ...
    SB_buffer = save_df_to_csv(SB_summary)
        ...
        # Update Google Sheets
    update_google_sheet("Business_Order_Report_Summary", TO_Summary)
    update_google_sheet("Order_Report_Summary", OR_summary)
    update_google_sheet("Return_Order_Report_Summary", RO_summary)
